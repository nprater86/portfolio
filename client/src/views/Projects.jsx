        ...
        <div id="projectsSection">
            ...
            <div className="row d-none d-md-block">
                <div className="row justify-content-between">
                    ...
                    <div className="col-4">
                        <img onClick={ e => imgDisplayOpen(storefronts) } className="img-thumbnail mb-3 thumbnail" src={storefronts} alt="" />
                    </div>
                </div>
                <div className="row justify-content-between">
                    <div className="col-4">
                        ...
                        <a href="https://www.youtube.com/watch?v=L2REJARYuYQ">Demo</a>
                    </div>
                    <div className="col-4">
                ...
                <div className="position-absolute top-50 start-50 translate-middle px-5 pb-5 pt-4 w-100 border flex-column rounded" style={{backgroundColor: 'black', display:imgDisplay}} id="popup">
                    ...
                    <div style={{paddingBottom: "56.25%"}}>
                        <iframe style={{width:"500px", height: "100%"}} src={src} frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <div className="row d-md-none">
                <div className="row align-items-center">
                    <div className="col-6">
                    <a href="https://www.youtube.com/watch?v=L2REJARYuYQ"><img className="img-thumbnail mb-3 thumbnail" src={drinkmixr} alt="" /></a>
                    </div>
                    <div className="col-6">
                ...
                <div className="row align-items-center">
                    <div className="col-6">
                    <img className="img-thumbnail mb-3 thumbnail" src={dojoweather} alt="" />
                    </div>
                    <div className="col-6">
                ...
                <div className="row align-items-center">
                    <div className="col-6">
                        <img className="img-thumbnail mb-3 thumbnail" src={storefronts} alt="" />
                    </div>
                    <div className="col-6">
