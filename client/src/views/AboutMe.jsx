...
const AboutMe = props => {
    return (
        <div id="aboutMeSection">
            ...
            <p>My name is Nathan Prater, and I am an aspiring front and back end developer skilled in Python, MERN, C#, and Java. I really enjoy coding and the challenges that it brings.</p>
